...
from Crypto.Cipher import AES #pip install pycryptodome 설치 ... 패키지 설치삽질 
import hashlib
import base64
import argparse
...
def main(path,flag):
  import sys
  if flag==1:
    sys.argv=a=[sys.argv[0],f'{path}/data/com.kakao.talk/databases/Kakaotalk.db']
  else:
    sys.argv=a=[sys.argv[0],f'{path}/data/com.kakao.talk/databases/KakaoTalk2.db']
  print(sys.argv)
  do_print = False
  dec_suffix = '_dec'
  enc_schema = {
